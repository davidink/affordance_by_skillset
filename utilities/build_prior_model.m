...
features = csvread([dataFolder,'features.txt']);
results = csvread([dataFolder,'results.txt']);
...
num_outlier=0;
for i=1:n
    if abs(obj_position_after(i,1)) > 0.02 | obj_position_after(i,3) < 0 | obj_position_after(i,3) - obj_position_before(i,3) < 0  
