...
pred_err = [];
load 'rslts/sub_1_feat17-40feat1-17_cv1.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_1_feat17-40feat1-17_cv2.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_1_feat17-40feat1-17_cv3.mat'
pred_err = [pred_err;pred_test_err];
pred_err_sub{4} = pred_err;

% pred_err = [];
% load 'rslts/sub_1_feat17+316feat17+316_cv1.mat'
% pred_err = [pred_err;pred_test_err];
% load 'rslts/sub_1_feat17+316feat17+316_cv2.mat'
% pred_err = [pred_err;pred_test_err];
% load 'rslts/sub_1_feat17+316feat17+316_cv3.mat'
% pred_err = [pred_err;pred_test_err];
% pred_err_sub{5} = pred_err;

pred_err = [];
load 'rslts/sub_1_feat17feat18-40_cv1.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_1_feat17feat18-40_cv2.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_1_feat17feat18-40_cv3.mat'
pred_err = [pred_err;pred_test_err];
pred_err_sub{5} = pred_err;

pred_err = [];
load 'rslts/sub_1_feat41-357feat1-17_cv1.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_1_feat41-357feat1-17_cv2.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_1_feat41-357feat1-17_cv3.mat'
pred_err = [pred_err;pred_test_err];
pred_err_sub{6} = pred_err;

pred_err = [];
load 'rslts/sub_1_feat18-40feat40_cv1.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_1_feat18-40feat40_cv2.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_1_feat18-40feat40_cv3.mat'
pred_err = [pred_err;pred_test_err];
pred_err_sub{7} = pred_err;

pred_err = [];
load 'rslts/sub_1_feat17feat40_cv1.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_1_feat17feat40_cv2.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_1_feat17feat40_cv3.mat'
pred_err = [pred_err;pred_test_err];
