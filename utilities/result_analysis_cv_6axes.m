...
pred_err = [];
load 'rslts/sub_1_6axes_gmm_init_cv_1.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_1_6axes_gmm_init_cv_2.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_1_6axes_gmm_init_cv_3.mat'
pred_err = [pred_err;pred_test_err];
pred_err_sub{1} = pred_err;

pred_err = [];
load 'rslts/sub_2_6axes_gmm_init_cv_1.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_2_6axes_gmm_init_cv_2.mat'
pred_err = [pred_err;pred_test_err];
