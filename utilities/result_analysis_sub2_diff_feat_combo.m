...
pred_err = [];
load 'rslts/sub_2_featset1_cv1.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_2_featset1_cv2.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_2_featset1_cv3.mat'
pred_err = [pred_err;pred_test_err];
pred_err_sub{1} = pred_err;

pred_err = [];
load 'rslts/sub_2_featset2_cv1.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_2_featset2_cv2.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_2_featset2_cv3.mat'
pred_err = [pred_err;pred_test_err];
pred_err_sub{2} = pred_err;

pred_err = [];
load 'rslts/sub_2_featset3_cv1.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_2_featset3_cv2.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_2_featset3_cv3.mat'
pred_err = [pred_err;pred_test_err];
pred_err_sub{3} = pred_err;

pred_err = [];
load 'rslts/sub_2_featset4_cv1.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_2_featset4_cv2.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_2_featset4_cv3.mat'
pred_err = [pred_err;pred_test_err];
pred_err_sub{4} = pred_err;

pred_err = [];
load 'rslts/sub_2_featset5_cv1.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_2_featset5_cv2.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_2_featset5_cv3.mat'
pred_err = [pred_err;pred_test_err];
pred_err_sub{5} = pred_err;

pred_err = [];
load 'rslts/sub_2_featset6_cv1.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_2_featset6_cv2.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_2_featset6_cv3.mat'
pred_err = [pred_err;pred_test_err];
pred_err_sub{6} = pred_err;

pred_err = [];
load 'rslts/sub_2_featset7_cv1.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_2_featset7_cv2.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_2_featset7_cv3.mat'
pred_err = [pred_err;pred_test_err];
pred_err_sub{7} = pred_err;

pred_err = [];
load 'rslts/sub_2_featset8_cv1.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_2_featset8_cv2.mat'
pred_err = [pred_err;pred_test_err];
load 'rslts/sub_2_featset8_cv3.mat'
pred_err = [pred_err;pred_test_err];
