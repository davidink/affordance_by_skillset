...
dataFolder = 'data/trajectories/push_1_object_7/';
...
dataFolder = 'data/trajectories/push_2_object_2/';
num_scene = size(dir([dataFolder 'trajectory*']),1);
%save features and results
opt_save_kernel_feat = false;
opt_save_feat_n_result = true;
for i=1:num_scene
    % load up the scene    
    load_trajectories_kok_multiobj(dataFolder,i,opt_save_kernel_feat,opt_save_feat_n_result);
end
